<template>
  <div style="height: 100vh; overflow: hidden; display: flex; align-items: center; justify-content: center; background-color: #609943">
      ...
      <div style="flex: 1; display: flex; align-items: center; justify-content: center;">
        <el-form :model="user" style="width: 80%" :rules="rules" ref="registerRef">
          ...
          <div style="display: flex">
            <div style="flex: 1">已经有账号了？去<span style="color: #4D9880FF; cursor: pointer" @click="$router.push('/login')">登录</span></div>
            <div style="flex: 1; text-align: right"> <span style="color: #4D9880FF; cursor: pointer">忘记密码</span> </div>
          </div>
        </el-form>
      </div>
